...
the manifest, and the target contract hash. Either the NEF file or the manifest
may be omitted, but not both.

```
$ ./bin/neo-go contract update -i contract.nef -m contract.manifest.json -r http://localhost:20331 -w wallet.json 4bfd65abeac8f85931f2d85cfdbc61de3dd03b94
```
...
```bash
$ ./bin/neo-go contract destroy -r http://localhost:20331 -w wallet.json 4bfd65abeac8f85931f2d85cfdbc61de3dd03b94
```
