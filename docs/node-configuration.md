...
| MaxBlockSystemFee | `int64` | `900000000000` | Maximum overall transactions system fee per block. Applied at consensus level and for mempool transactions filtering only. |
