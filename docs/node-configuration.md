...
| `Gorgon`        | Fixes `SHR` and `SHL` VM opcode handlers for the case of zero shift. | https://github.com/nspcc-dev/neo-go/pull/4197 <br> https://github.com/neo-project/neo/pull/4516 |
