...
// CalculateNetworkFee calculates network fee for a transaction. The transaction may
...
// GetBestBlockHash returns the hash of the tallest block in the mainchain.
...
// GetBlockCount returns the number of blocks in the mainchain.
