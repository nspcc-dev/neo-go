...
func TestEmitArray(t *testing.T) {
	t.Run("good", func(t *testing.T) {
		...
		Array(buf, big.NewInt(0), veryBig,
...
func TestEmitOpcode(t *testing.T) {
	...
	Opcodes(w, opcode.PUSH1, opcode.NEWMAP)
	result := w.Bytes()
