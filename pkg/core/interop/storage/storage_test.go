...
func TestStorage_LocalInteropAPI(t *testing.T) {
	...
	src := `package foo
		...
		func FindLocal() bool {
			return iterator.Next(storage.FindLocal("key", storage.None))
		}`
	...
	ctrInvoker.InvokeFail(t, "System.Storage.Local.Put failed: syscall not found", "putLocal")
	ctrInvoker.InvokeFail(t, "System.Storage.Local.Get failed: syscall not found", "getLocal")
	ctrInvoker.InvokeFail(t, "System.Storage.Local.Delete failed: syscall not found", "deleteLocal")
	ctrInvoker.InvokeFail(t, "System.Storage.Local.Find failed: syscall not found", "findLocal")
	ctrInvoker.Invoke(t, nil, "putLocal")
	ctrInvoker.Invoke(t, stackitem.Make([]byte("val")), "getLocal")
	ctrInvoker.Invoke(t, nil, "deleteLocal")
	ctrInvoker.Invoke(t, stackitem.Make(false), "findLocal")
}
