...
func TestSnapshotIsolation_Exceptions(t *testing.T) {
	...
	ctrA := neotest.CompileSource(t, acc.ScriptHash(), strings.NewReader(srcA), &compiler.Options{
		...
		ContractEvents: []manifest.Event{
			{Name: "NotificationFromA", Parameters: []manifest.Parameter{manifest.Parameter{Name: "i", Type: smartcontract.IntegerType}}},
		},
	})
	e.DeployContract(t, ctrA, nil)
	...
	ctrB := neotest.CompileSource(t, acc.ScriptHash(), strings.NewReader(srcB), &compiler.Options{
		...
		Permissions:        []manifest.Permission{{Methods: manifest.WildStrings{Value: nil}}},
		ContractEvents: []manifest.Event{
			{Name: "NotificationFromB before panic", Parameters: []manifest.Parameter{manifest.Parameter{Name: "i", Type: smartcontract.IntegerType}}},
			{Name: "NotificationFromB after panic", Parameters: []manifest.Parameter{manifest.Parameter{Name: "i", Type: smartcontract.IntegerType}}},
		},
	})
	e.DeployContract(t, ctrB, nil)
