...
var systemInterops = []interop.Function{
	...
	{Name: interopnames.SystemStorageFindWithStart, Func: storage.FindWithStart, Price: 1 << 15,
		RequiredFlags: callflag.ReadStates, ActiveFrom: config.HFHuyao},
	...
	{Name: interopnames.SystemStorageLocalFind, Func: storage.LocalFind, Price: 1 << 15,
		RequiredFlags: callflag.ReadStates, ActiveFrom: config.HFFaun},
	{Name: interopnames.SystemStorageLocalFindWithStart, Func: storage.LocalFindWithStart, Price: 1 << 15,
		RequiredFlags: callflag.ReadStates, ActiveFrom: config.HFHuyao},
