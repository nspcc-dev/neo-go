...
func (bc *Blockchain) GoverningTokenHash() util.Uint160 {
	// TODO: such replacement is valid iff we're not going to change their names and other hashable fields.
	// I.e. if we only consider a replacement of contract implementation. I think for NeoFS purposes it's sufficient
	// and we can get rid of methods like (bc *Blockchain) GoverningTokenHash().
