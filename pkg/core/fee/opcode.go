...
var (
	...
	catW                  = []float64{1.32937716e-01, 7.02639535e+02}
	...
	memcpyW               = []float64{2.57151131e-02, 1.34430233e+02}
	newArrayBooleanW      = []float64{7.93995276, 1111.14925509}
	newArrayIntegerW      = []float64{31.89135174, 9076.28670058}
	newArrayByteArrayW    = []float64{29.65833939, 8727.1699673}
	newArrayAnyW          = []float64{8.40720385, 1445.4885992}
	newBuffer             = []float64{1.00956181e-01, 1.60198837e+03}
	...
	reverseW              = []float64{2.31359012, -86.59338663}
	rollW                 = []float64{2.19313227, -395.79978198}
	...
	substrW               = []float64{1.69512072e-01, -7.79627907e+02}
	unpackAnyW            = []float64{10.76466731, 19.61487305, 1862.62836781}
	...
	xDropW                = []float64{5.37511789, 5.50422592, 757.59834601}
)
...
func NewArrayGas(args ...any) float64 {
	...
	case stackitem.BooleanT:
		return floats.Dot(newArrayBooleanW, []float64{float64(l), 1})
	case stackitem.IntegerT:
		return floats.Dot(newArrayIntegerW, []float64{float64(l), 1})
