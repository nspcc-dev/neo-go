...
var (
	...
	convertArrayOrStructW     = []int64{77, 134, 3218}
	convertByteArrayOrBufferW = []int64{7, 3417}
	dropW                     = []int64{99, 1486}
	...
	removeArrayOrStructW      = []int64{98, 9, 1991}
	removeMapW                = []int64{96, 706, 6776}
	reverseItemsArrayW        = []int64{98, 19, 2043}
	reverseItemsBufferW       = []int64{9, 1690}
...
// OpcodeV1 returns opcode pricing in femtoGAS units. It is used since the
// Huyao hardfork and supports dynamic (parameter-dependent) costs.
...
func convertGas(params *vm.OpcodePriceParams) int64 {
	...
	case stackitem.ArrayT:
		return convertArrayOrStructW[0]*int64(params.RefsDelta) + convertArrayOrStructW[1]*int64(params.Length) + convertArrayOrStructW[2]
	case stackitem.ByteArrayT:
		return convertByteArrayOrBufferW[0]*int64(params.Length) + convertByteArrayOrBufferW[1]
	default:
		panic("invalid type")
	}
}
...
func removeGas(params *vm.OpcodePriceParams) int64 {
	...
	return removeArrayOrStructW[0]*int64(params.RefsDelta) + removeArrayOrStructW[1]*int64(params.Length) + removeArrayOrStructW[2]
}

func reverseItemsGas(params *vm.OpcodePriceParams) int64 {
	if params.Typ == stackitem.BufferT {
		return reverseItemsBufferW[0]*int64(params.Length) + reverseItemsBufferW[1]
	}
	return reverseItemsArrayW[0]*int64(params.RefsDelta) + reverseItemsArrayW[1]*int64(params.Length) + reverseItemsArrayW[2]
}
