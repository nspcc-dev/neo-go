...
var (
	...
	huyaoCSS = map[string]string{
		nativenames.Policy: `{"id":-7,"hash":"0xcc5e4edd9f5f8dba8bb65734541df7a1c081c67b","nef":{"magic":860243278,"compiler":"neo-core-v3.0","source":"","tokens":[],"script":"EEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQA==","checksum":2426471238},"manifest":{"name":"PolicyContract","abi":{"methods":[{"name":"activateHardfork","offset":0,"parameters":[{"name":"hardfork","type":"ByteArray"}],"returntype":"Void","safe":false},{"name":"blockAccount","offset":7,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":false},{"name":"getAttributeFee","offset":14,"parameters":[{"name":"attributeType","type":"Integer"}],"returntype":"Integer","safe":true},{"name":"getBlockedAccounts","offset":21,"parameters":[],"returntype":"InteropInterface","safe":true},{"name":"getExecFeeFactor","offset":28,"parameters":[],"returntype":"Integer","safe":true},{"name":"getExecPicoFeeFactor","offset":35,"parameters":[],"returntype":"Integer","safe":true},{"name":"getFeePerByte","offset":42,"parameters":[],"returntype":"Integer","safe":true},{"name":"getHardforkActivationHeight","offset":49,"parameters":[{"name":"hardfork","type":"ByteArray"}],"returntype":"Integer","safe":true},{"name":"getMaxTraceableBlocks","offset":56,"parameters":[],"returntype":"Integer","safe":true},{"name":"getMaxValidUntilBlockIncrement","offset":63,"parameters":[],"returntype":"Integer","safe":true},{"name":"getMillisecondsPerBlock","offset":70,"parameters":[],"returntype":"Integer","safe":true},{"name":"getStoragePrice","offset":77,"parameters":[],"returntype":"Integer","safe":true},{"name":"getWhitelistFeeContracts","offset":84,"parameters":[],"returntype":"InteropInterface","safe":true},{"name":"isBlocked","offset":91,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":true},{"name":"recoverFund","offset":98,"parameters":[{"name":"account","type":"Hash160"},{"name":"token","type":"Hash160"}],"returntype":"Boolean","safe":false},{"name":"removeWhitelistFeeContract","offset":105,"parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setAttributeFee","offset":112,"parameters":[{"name":"attributeType","type":"Integer"},{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setExecFeeFactor","offset":119,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setFeePerByte","offset":126,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMaxTraceableBlocks","offset":133,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMaxValidUntilBlockIncrement","offset":140,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMillisecondsPerBlock","offset":147,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setStoragePrice","offset":154,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setWhitelistFeeContract","offset":161,"parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fixedFee","type":"Integer"}],"returntype":"Void","safe":false},{"name":"unblockAccount","offset":168,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":false}],"events":[{"name":"MillisecondsPerBlockChanged","parameters":[{"name":"old","type":"Integer"},{"name":"new","type":"Integer"}]},{"name":"WhitelistFeeChanged","parameters":[{"name":"contract","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fee","type":"Any"}]},{"name":"RecoveredFund","parameters":[{"name":"account","type":"Hash160"}]},{"name":"HardforkActivationScheduled","parameters":[{"name":"hardfork","type":"String"},{"name":"activationHeight","type":"Integer"}]}]},"features":{},"groups":[],"permissions":[{"contract":"*","methods":"*"}],"supportedstandards":[],"trusts":[],"extra":null},"updatecounter":0}`,
	}
...
func TestManagement_VotingContractDestroy(t *testing.T) {
	check := func(t *testing.T, gorgonActivation uint32) {
      ...
      func OnNEP17Payment(from interop.Hash160, amount int, data any) {
		...
		if c.Chain.IsHardforkEnabled(&gorgon, c.Chain.BlockHeight(), nil, false) {
			expected = append(expected, state.NotificationEvent{
				Name:       "OnNEP17Payment",
				ScriptHash: ctr.Hash,
				Item: stackitem.NewArray([]stackitem.Item{
