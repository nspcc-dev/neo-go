...
const (
	...
	// DefaultStateInterval is the default interval for state of state object.
	DefaultStateInterval = 40000
...
// New creates a new BasicService instance.
func New(cfg config.NeoFSService) (BasicService, error) {
	var (
		account *wallet.Account
		err     error
	)
