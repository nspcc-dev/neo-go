	...
	"getversion": {
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":{"tcpport":20332,"wsport":20342,"nonce":2153672787,"useragent":"/NEO-GO:0.73.1-pre-273-ge381358/", "protocol": {"network": 2, "hardforks": {}}, "application": {"saveinvocations": true,"keeponlylateststate": true}, "rpc": {"maxiteratorresultitems": 100, "sessionenabled": true}}`,
			result: func(c *Client) any {
...
func wrapInitResponse(r *params.In, resp string) string {
	...
	switch r.Method {
	case "getversion":
		response = `{"id":1,"jsonrpc":"2.0","result":{"protocol":{"network":42},"tcpport":20332,"wsport":20342,"nonce":2153672787,"useragent":"/NEO-GO:0.73.1-pre-273-ge381358/", "application": {"saveinvocations": true,"keeponlylateststate": true}, "rpc": {"maxiteratorresultitems": 100, "sessionenabled": true}}}`
