...
func TestDestroyTransactionAndUnsigned(t *testing.T) {
	actor := new(testAct)
	tok := New(actor, util.Uint160{1, 2, 3})

	for name, fn := range map[string]func() (interface{}, error){
		"DestroyTransaction": func() (interface{}, error) {
			return tok.DestroyTransaction()
		},
		"DestroyUnsigned": func() (interface{}, error) {
