...
func TestExtendedType_IsValid(t *testing.T) {
	...
	et.Name = "42"
	require.ErrorContains(t, et.IsValid(), "`ExtendedType.Name` must start with a letter")
	et.Name = "a_"
	require.ErrorContains(t, et.IsValid(), "`ExtendedType.Name` can contain alphanumeric characters and dots")
	et.Type = smartcontract.UnknownType
	et.Name = ""
	et.Length = 42
