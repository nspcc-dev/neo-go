...
// NewTransferFromOwner returns the transaction transferring funds from NEO and GAS owner.
...
// NewDeployTx returns new deployment for a contract with the source from r and a name equal to
